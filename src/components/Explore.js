...
export function Explore({ token, projects }) {
    ...
    const handleInteraction = async (projectID, state, token) => {
        try {
                        ...
                        <CardFooter className="flex flex-col gap-3">
                            ...
                            <div className="flex justify-between w-full">
                                <Button
                                    ...
                                    onClick={() => handleInteraction(currentProject._id,0, token)}
                                >
                                ...
                                <Button
                                    ...
                                    onClick={() => handleInteraction(currentProject._id, 1, token)}
                                >
